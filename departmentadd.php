...
//        if(mysqli_num_rows($check_email)<1){
	$sql="INSERT INTO `departments`( `DomainName`) VALUES ( '$domain')";
	echo "$sql";
...
<div class="gcse-searchbox-only" data-resultsUrl="https://googlecustomsearch.appspot.com/elementv2/two-page_results_elements_v2.html?query=test"></div>
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-6">
            	...
            	<input type="text"  onkeypress="return /[a-z]/i.test(event.key)" class="form-control" name="login_domain" placeholder="Domain Name" minlength="3" required> <br>

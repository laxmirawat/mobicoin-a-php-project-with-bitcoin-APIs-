              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="qaz">
                    <p>
                    <p> <b> Account: </b> <?php echo $_SESSION['login_user_admin']; ?></p> <br>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <b> Send to:</b>
                    <input type="text" name="userid" class="dd"   width="100%" height="100%" required> <br>
                  <b>  amount:</b>
                    <input type="text" name="amount" class="dd"  width="100%" height="100%" required > <br> <br>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <button type="button" class="btn btn-outline-success and-all-other-classes"> 
                       <a href="rewards.php" style="color:inherit"> <b>View My Rewards <b> </a>
                            </button>
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <button type="button" class="btn btn-outline-success and-all-other-classes"> 
                  <a href="history.php" style="color:inherit" > <b> History <b> </a> 
                            </button>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                    </div>
